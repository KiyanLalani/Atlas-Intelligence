...
enum Environment {
    ...
    var baseURL: String {
        ...
        case .production:
            // Update with your actual production server URL that will be used for TestFlight and App Store
            return "https://api.atlasai.com/api"  // Replace with your actual production server
        }
    }
}
